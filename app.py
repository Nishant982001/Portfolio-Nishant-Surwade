...
with main:
    ...
    with gmail:
        st.button("","mailto:nishantsurwade982001@gmail.com",use_container_width=True,icon=":material/mail:")
    with linked:
        st.link_button("linked-in","https://www.linkedin.com/in/nishantsurwade8314/",use_container_width=True)
    with insta:
